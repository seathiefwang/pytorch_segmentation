    ...
    def __init__(self, root, split, mean, std, base_size=None, augment=True, val=False,
        ...
        if not self.val:
            self.affine_augmenter = albu.Compose([
                            ...
                            albu.Rotate(limit=45, value=0, mask_value=255, border_mode=cv2.BORDER_CONSTANT, p=0.005)
                            ])
            ...
            self.image_augmenter = albu.Compose([
                            ...
                            albu.RandomBrightnessContrast(0.15,0.15, p=0.005),
                            albu.OneOf([
                            ...
                            albu.HueSaturationValue(hue_shift_limit=0, sat_shift_limit=10, val_shift_limit=20,p=0.0002),
                            albu.JpegCompression(90, 100, p=0.0001)
                            ])

            self.resizer = albu.Compose([
                            albu.Resize(base_size, base_size, p=1),
                            albu.RandomScale(scale_limit=(-0.2, 0.25), p=0.005),
